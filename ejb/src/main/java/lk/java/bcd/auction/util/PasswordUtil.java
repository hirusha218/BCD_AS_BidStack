package lk.java.bcd.auction.util;

/**
 * Conceptual Password Utility for EJB Module.
...
public class PasswordUtil {
    ...
    public static String hashPassword(String plainPassword) {
        ...
        System.err.println("WARNING: Using DUMMY password hashing in EJB util. NOT FOR PRODUCTION.");
    ...
    public static boolean checkPassword(String plainPassword, String hashedPassword) {
        ...
        System.err.println("WARNING: Using DUMMY password checking in EJB util. NOT FOR PRODUCTION.");
